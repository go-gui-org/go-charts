...
var demoEntries = []DemoEntry{
	...
	{ID: "gauge_gradient", Label: "Gauge Gradient Sweep", Group: groupGauge, Summary: "Zone colors blended into one continuous sweep along the arc.", Tags: []string{"gauge", "gradient", "zone", "sweep", "blend"}},
	{ID: "gauge_arc_ramp", Label: "Gauge Arc Ramp", Group: groupGauge, Summary: "Explicit color ramp along the arc with no zones.", Tags: []string{"gauge", "gradient", "ramp", "stops"}},
